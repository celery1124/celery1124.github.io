  ...
  $('.js-form').submit(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        showModal('Comment submitted', 'Thanks! Your comment is <a href="https://github.com/celery1124/celery1124.github.io/pulls">pending</a>. It will appear when approved.');
